    ...
    render () {
        ...
        return (
            <div>
                ...
                buttonData='{"website":"GitHub","category":"paywall","description":"swipe code","owner":"swarnavo"}'
                label="Test Your Button"
                onPayment={this.mbOnPaymentCallback}></MoneyButton>
                ) : null}

{ !this.state.paid ? (
                <MoneyButton to='145' type='buy' amount='10' currency='USD' 
                buttonData='{"website":"GitHub","category":"paywall","description":"swipe code","owner":"swarnavo"}'
                label="% TIP "
                onPayment={this.mbOnPaymentCallback}></MoneyButton>
                ) : null}
