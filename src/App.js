        ...
        <div style={{"alignText":"left", padding:"20px"}}>
          ...
          <Container>
            ...
            <div>
              ...
              <Blur radius={!this.state.paidForCode ? '1px' : '0' } transition="200ms"> {/* ! */}
...
{/* <p><a href="http://localhost:3001/" target="someFrame">Web3 Ecommerce Site </a></p>
{ <iframe name="someFrame" width="1000" height="400"></iframe> }
 */}
          <Card> 
            <CardBody>
